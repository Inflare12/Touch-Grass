...
data class AppSettings(
    ...
    val sensitivity: String = "NORMAL", // "LOW", "NORMAL", "HIGH"
...
class PreferencesManager(private val context: Context) {
    ...
    suspend fun setGlobalDailyLimitMinutes(minutes: Int) {
        context.dataStore.edit { it[Keys.GLOBAL_LIMIT_MINUTES] = minutes }
    }

    suspend fun setHoldDurationSeconds(seconds: Int) {
        context.dataStore.edit { it[Keys.HOLD_DURATION_SECONDS] = seconds }
    }
    ...
    suspend fun setFunnyMessagesEnabled(enabled: Boolean) {
        context.dataStore.edit { it[Keys.FUNNY_MESSAGES_ENABLED] = enabled }
    }
    ...
    suspend fun setInterventionOverlayEnabled(enabled: Boolean) {
        context.dataStore.edit { it[Keys.INTERVENTION_OVERLAY_ENABLED] = enabled }
    }

    suspend fun setLastInterventionTime(time: Long) {
        context.dataStore.edit { it[Keys.LAST_INTERVENTION_TIME] = time }
    }
